...
// CTA section for property owners with background image and "Learn More" button.
...
export default function PropertyManagement() {
    return (
        ...
        >
            ...
            {/* Content */}
            <div className="relative z-10 flex items-center justify-around mx-auto px-6 text-center">
                <div>
               ...
               <Button className="h-14 w-48 bg-primary text-white" href="/property-investment-2" variant="primary">
                    Learn More
                </Button> 
            </div>
